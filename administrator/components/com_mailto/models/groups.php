 ...
 * @since       8.0
 */
class MailtoModelgroups extends JModelList
{
	/**
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id, a.title, a.note, a.checked_out, a.checked_out_time,' .
				'a.published, a.access, a.created_time, a.ordering'
			)
		);
		$query->from('#__mailto_email_groups AS a');
